...
export const iconPaths = {
  ...
  fruit:
    'M12 8c-2.5-1.8-7-.8-7 4.5 0 4 2.6 7.5 4.8 7.5 1 0 1.4-.5 2.2-.5s1.2.5 2.2.5c2.2 0 4.8-3.5 4.8-7.5 0-5.3-4.5-6.3-7-4.5zM12 8c0-2 1-3.6 3-4.5',
  steps:
    'M7.5 3.5c1.7 0 2.7 2 2.7 4.3S9.3 12 7.5 12s-2.6-1.9-2.6-4.2S5.8 3.5 7.5 3.5zM5.5 14.5h4v1.7a2 2 0 0 1-4 0zM16.5 7.5c1.7 0 2.6 2 2.6 4.3S18.2 16 16.5 16s-2.7-1.9-2.7-4.2.9-4.3 2.7-4.3zM14.5 18.5h4v.5a2 2 0 0 1-4 0z',
  book: 'M4 19.5V5a2 2 0 0 1 2-2h14v15H6a2 2 0 0 0-2 2 2 2 0 0 0 2 2h14M8 7h8',
  pill: 'M10.5 20.5a4.95 4.95 0 0 1-7-7l6-6a4.95 4.95 0 0 1 7 7zM8.5 8.5l7 7',
  minus: 'M5 12h14',
  flame: 'M12 3c.8 3.2 5 5.2 5 10a5 5 0 0 1-10 0c0-2.2 1.1-3.8 2.2-4.8.1 1.9.9 3 2 3.2-.5-3 .2-5.8.8-8.4z',
